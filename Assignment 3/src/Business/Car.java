...
public class Car {
    ...
    public Car(boolean available, String brand, int manufactured_year, int min_seats, int max_seats, int serial_num, String model_num, String available_city, boolean maintenance_certificate) {
